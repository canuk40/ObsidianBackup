...
package com.obsidianbackup.navigation
...
sealed class Screen(val route: String, val title: String, val icon: ImageVector) {
    ...
    object ZeroKnowledge : Screen("zero_knowledge", "Zero-Knowledge", Icons.Default.Security)
    object CloudProviders : Screen("cloud_providers", "Cloud Providers", Icons.Default.Cloud)
    object Filecoin : Screen("filecoin", "Filecoin", Icons.Default.Public)
